...
Author - Thaduri Prathyusha Reddy
...
1. Clone the repository:
   ```sh
   git clone https://github.com/TPrathyusha31/LearningSeleniumATB10x/tree/master
   ```
...
- GitHub: [Your GitHub](https://github.com/TPrathyusha31/)